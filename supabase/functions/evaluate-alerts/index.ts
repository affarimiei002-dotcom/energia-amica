    ...
    const isMockEmail = !RESEND_API_KEY;
      ...
      for (const contract of contracts) {
              ...
              if (!userEmail) continue;
                ...
                if (daysLeft <= 0) {
                            // Contract is EXPIRED - generate alert once every 24h
                            ...
                            // Contract expiring soon - check offset thresholds (30, 7, 1 days)
                            for (const offset of offsets) {
                                          if (daysLeft <= offset) {
                                            ...
                                            if (!existing?.length) {
                                                          ...
                                                          break; // Only one reminder per evaluation cycle
                                          }
                            }
                }
                }
